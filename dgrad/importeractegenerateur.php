        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <h1>LISTE DE TOUS LES ACTES GENERATEURS</h1>
                    ...
                    <div id="tableau_acte_generateur"></div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="formulaireModification" method="post">
                                        ...
                                        <div class="form-group mb-2">
                                            <label for="serviceM">Choisir le service</label>

                                            <select class="form-control" id="serviceM" name="serviceM">

                                            </select>
                                        </div>

                                        <div class="form-group mb-2">
                                            <label for="categorieActeM">Choisir la categorie</label>

                                            <select class="form-control" id="categorieActeM" name="categorieActeM">
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#anneeSelection").change(function () {
                ...
                if (anneeSelection != "") {
                    $.ajax({
                        url: 'traitement/tableau_actes_generateurs.php',
                        method: 'POST',
                        dataType: 'html',
                        data: {
                        ...
                        success: function (response) {
                            document.getElementById('tableau_acte_generateur')
                                .innerHTML = response
                        },
            ...
            $("#serviceM").change(function () {
                var service = $(this).val();

                if (exercice != "") {
                    $.ajax({
                        url: 'traitement/selectCategorieActeParService.php',
                        method: 'POST',
                        dataType: 'html',
                        data: {
                            service: service
            ...
            function actes_generateurs() {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        document.getElementById('tableau_acte_generateur').innerHTML = response
                    },
                    error: function (xhr, ajaxOptions, thrownError) {
                        console.log(xhr.status);
                        console.log(thrownError);
            ...
            $('#confirmAction').on('click', function () {
                ...
                var exerice = $("#exerciceM").val(); // Récupérer la province
                var service = $("#serviceM").val(); // Récupérer la province
                var categorieActe = $("#categorieActeM").val(); // Récupérer la province
                ...
                $.ajax({
                    url: 'traitement/affecter_categorie_acte_et_service_dans_acte_generateur.php', // URL du script PHP
            ...
            $('#formulaireImporter').submit(function () {
                ...
                $.ajax({
                    url: 'traitement/importeractesgenerateurs.php',
                    type: 'POST',
