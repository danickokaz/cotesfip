        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <h1>LISTE DE TOUTES LES CATEGORIES D'ACTES GENERATEURS</h1>
                    ...
                    <div id="tableau_categorie_acte_generateur"></div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#anneeSelection").change(function () {
                ...
                if (anneeSelection != "") {
                    $.ajax({
                        url: 'traitement/tableau_categories_actes_generateurs.php',
                        method: 'POST',
                        dataType: 'html',
                        data: {
                        ...
                        success: function (response) {
                            document.getElementById('tableau_categorie_acte_generateur')
                                .innerHTML = response
                        },
            ...
            function categories_actes_generateurs() {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        document.getElementById('tableau_categorie_acte_generateur').innerHTML =
                            response
                    },
                    error: function (xhr, ajaxOptions, thrownError) {
                        console.log(xhr.status);
            ...
            $('#confirmAction').on('click', function () {
                ...
                var exercice = $("#exerciceM").val(); // Récupérer la province
                ...
                $.ajax({
                    url: 'traitement/affecter_service_et_annee_dans_categorie_acte.php', // URL du script PHP
            ...
            $('#formulaireImporter').submit(function () {
                ...
                $.ajax({
                    url: 'traitement/importercategoriesactesgenerateurs.php',
                    type: 'POST',
