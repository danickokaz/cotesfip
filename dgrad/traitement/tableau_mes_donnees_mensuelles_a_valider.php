...
if (isset($_SESSION['jlk']) && !empty($_SESSION['jlk'])) {
    ...
    if ($req->rowCount() === 1) {
        ...
        if($id_role === 1){
            ...
            if (isset($_POST['moisVoirDonnees'], $_POST['anneeVoirDonnees'],$_POST['province'],$_POST['servicesV']) && !empty($_POST['moisVoirDonnees']) && !empty($_POST['anneeVoirDonnees'])
            and !empty($_POST['province']) and !empty($_POST['servicesV'])) {
                $mois = htmlspecialchars($_POST['moisVoirDonnees']);
                $annee = htmlspecialchars($_POST['anneeVoirDonnees']);
                $province = htmlspecialchars($_POST['province']);
                $services = htmlspecialchars($_POST['servicesV']);
    
                function afficherTableau($services, $province, $mois, $annee) {
                    $bdd = database();
                    ...
                    $stmt->execute([$services,$province, $mois, $annee]);
                    ...
                    foreach ($resultats as $row) {
                        ...
                        if($row['id_etat_donnee'] == 1){
                            ...
                            echo '<td style="text-align:center;">DEP</td>';
                            echo "</tr>";
                            ...
                            echo '<td style="text-align:center;">CABINET</td>';
                            echo "</tr>";
                        }
                ...
                afficherTableau($services,$province, $mois, $annee);
            }
                ...
                function afficherTableau($services, $province, $mois, $annee) {
                    ...
                    foreach ($resultats as $row) {
                        ...
                        if($row['id_etat_donnee'] == 1){
                            ...
                            echo '<td style="text-align:center;">DGRAD</td>';
