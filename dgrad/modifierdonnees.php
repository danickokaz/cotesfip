...
<body>
                        ...
                        <div class="container">
                            <form method="post" id="formualireVoirDonnees">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="servicesM">Choisir le service</label>
                                            <select class="form-control" id="servicesM" name="servicesM">
    ...
    <script>
        $(document).ready(function () {
            ...
            function tableau(servicesM, mois, annee) {
                $.ajax({
                    url: 'traitement/tableau_mes_donnees_mensuelles_a_modifier.php',
                    type: 'POST',
                    data: {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response == 'success') {
                            ...
                            Swal.fire({
                                title: "Operationnn reussie!",
                                text: "Donnees modifiees",
                                icon: "success"
                            });
                            var mois = $("#moisVoirDonnees").val()
                            var annee = $("#anneeVoirDonnees").val()
                            var services = $("#servicesM").val()
