...
if (isset($_SESSION['access']) && !empty($_SESSION['access'])) {
    ...
    if ($req->rowCount() === 1) {
        ...
        if($id_role === 1){
            ...
            if (isset($_POST['moisVoirDonnees'], $_POST['anneeVoirDonnees'],$_POST['province'],$_POST['centre_perception']) && !empty($_POST['moisVoirDonnees']) && !empty($_POST['anneeVoirDonnees'])
            and !empty($_POST['province']) and !empty($_POST['centre_perception'])) {
                $mois = htmlspecialchars($_POST['moisVoirDonnees']);
                $annee = htmlspecialchars($_POST['anneeVoirDonnees']);
                $provinceChamp = htmlspecialchars($_POST['province']);
                ...
                afficherTableau($centre_perception,$provinceChamp, $mois, $annee);
            }
