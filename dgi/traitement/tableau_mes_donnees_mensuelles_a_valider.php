...
if (isset($_SESSION['visa']) && !empty($_SESSION['visa'])) {
    ...
    if ($req->rowCount() === 1) {
        ...
        //Administrateur du service (DGI)
        if($id_role == 1){


            if (isset($_POST['moisVoirDonnees'], $_POST['anneeVoirDonnees'],$_POST['centre_perception']) && !empty($_POST['moisVoirDonnees']) && !empty($_POST['anneeVoirDonnees']) and !empty($_POST['centre_perception'])) {
                $mois = htmlspecialchars($_POST['moisVoirDonnees']);
                $annee = htmlspecialchars($_POST['anneeVoirDonnees']);
                $centre_perception = htmlspecialchars($_POST['centre_perception']);
    
                function afficherTableau($centre_perception, $mois, $annee) {
                    $bdd = database();
                    ...
                    $stmt->execute([$centre_perception, $mois, $annee]);
                    ...
                    echo "<table border='1'>";
                    echo "<thead><tr><th>N</th><th>Code</th><th>Nature de Recette</th><th>Prévision</th><th>Réalisation</th><th>Position</th></tr></thead><tbody>";
                    ...
                    foreach ($resultats as $row) {
                        ...
                        if($row['id_etat_donnee'] == 1){
                            ...
                            echo '<td style="text-align:center;cursor:pointer;"><i class="fa fa-check validerDonneesParAdminService" id="'.$row['id'].'" ></i></td>';
                            echo "</tr>";
                            ...
                            echo '<td style="text-align:center;cursor:pointer;">DEP</td>';
                            echo "</tr>";
                ...
                afficherTableau($centre_perception, $mois, $annee);
            }

        }
        //Validateur de la DEP (DGI)
        else if($id_role == 2){
                ...
                function afficherTableau($centre_perception, $mois, $annee) {
                    ...
                    foreach ($resultats as $row) {
                        ...
                        if($row['id_etat_donnee'] == 2){
                            ...
                            echo '<td style="text-align:center;cursor:pointer;"><i class="fa fa-check validerDonneesParDep" id="'.$row['id'].'" ></i></td>';
                            echo "</tr>";
    
                            
                        }else if($row['id_etat_donnee'] == 1){
                            ...
                            echo '<td style="text-align:center;cursor:pointer;">DGI</td>';
                            echo "</tr>";
                            
                        }
                        else if($row['id_etat_donnee'] == 3){
                            ...
                            echo '<td style="text-align:center;cursor:pointer;">CABINET</td>';
                            echo "</tr>";
